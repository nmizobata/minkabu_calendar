...
class Mt4:
    def __init__(self, name):
        self.name=name
        self.datafolder, self.boxfolder, self.currency_list = self.__get_profile(self.name)
        
    def __get_profile(self,mt4_name):
        import pandas as pd
        mt4=pd.read_excel(".\\MT4_Tools\\MT4_common_lib\\mt4_info.xlsx")
        mt4_datafolder = mt4.loc[mt4["MT4_name"]==mt4_name]["datafolder"]
        mt4_boxfolder  = mt4.loc[mt4["MT4_name"]==mt4_name]["boxfolder"]
        ...
        return mt4_datafolder[0],mt4_boxfolder[0],currencies_list
...
class ChartFile:
    def __init__(self,path):
        import os
        self.path = path
        self.currencyname, self.symbol, self.timeframe = self.__get_currency_timeframe(self.path)
